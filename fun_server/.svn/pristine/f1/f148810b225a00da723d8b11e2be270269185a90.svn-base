...
## 项目情况
> 此项目本是在3年前，开发新的项目时，采用ssm搭建的一个原型；完成新项目后，本着开源的精神，整理共享出来，帮助后人，这就是现在的fun。  
...
## How to get/use it
> 
* 1、git clone https://github.com/Eliteams/fun.git
* 2、在MySQL中导入 fun/src/test/resources/fun.sql 脚本
* 3、更新 fun/src/main/resources/application.properties 中 JDBC Global Setting
* 4、cd fun
* 5、mvn war:war 
* 6、把 fun/target/fun.war 发布在App Server(Tomcat、JBOSS) 中


## 在IDE 中查看源码并运行
> #### 1 、在IntelliJ IDEA
* File -> Import Project -> select fun folder -> create project form existing sources -> ...
